...
\title{Class 26: Process Models and Agile Foundations}
\subtitle{Session 26 of 36 -- MLOps Block}
\author{\coursename}
\date{}
...
\begin{frame}{Recap: the four core process activities}
\begin{itemize}
\item Class 22 already introduced specification, development, validation, and evolution as the backbone of any software process.
\item This class does not repeat that material; it asks how those four activities get organized in time and by whom.
\end{itemize}
\begin{block}{ML-specific nuance, carried forward}
...
{Class 27 narrows that process discussion into practical agile tools such as backlogs, stories, boards, ceremonies, and feedback loops.}

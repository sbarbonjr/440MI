...
\title{Class 22: Introduction to Software Engineering for Data Products}
\subtitle{Session 22 of 36 -- Opening the MLOps \& Software Engineering Block}
\author{\coursename}
\date{}
...
\item This session opens the MLOps block and now also folds in the legacy ``process activities'' material as a single unit
\end{itemize}
\coursefooter
\end{frame}
...
{Class 23 moves into requirements engineering, turning stakeholder needs and quality attributes into testable specifications before design and code decisions are judged.}
{Engineering discipline around code and process sets up the same discipline around requirements: knowing precisely what ``good'' means before we build toward it.}

...
\title{Class 10: Python --- Exploratory Data Analysis}
\author{\coursename}
\date{}
...
{Class 11 uses this same habit of inspection right before fitting anything, as we take first contact with the scikit-learn API for training and evaluating a model.}
{We first learn to see the data clearly, then we decide how to encode, transform, or model it --- the theory of that transformation is picked up again in the Data-Driven block.}

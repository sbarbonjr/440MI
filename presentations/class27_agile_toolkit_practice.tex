...
\title{Class 27: Agile Toolkit for Data and ML Teams}
\subtitle{Session 27 of 36 -- One Integrated Agile Practice Session}
\author{\coursename}
\date{}
...
\end{itemize}
\begin{block}{Note}
This class now runs as one integrated practice session covering what used to be split across two meetings; sections are grouped into denser frames rather than a slower two-week pace.
\end{block}
\coursefooter
\end{frame}
...
Practice & Practical value in an ML project \\
\toprule
Sprint planning & Defines a thin vertical slice and aligns ambition with capacity. \\
Daily stand-up & Surfaces blockers such as missing labels or broken environments. \\
Backlog refinement & Clarifies data dependencies and acceptance criteria before work starts. \\
Retrospective & Improves how the team works, especially around experimentation waste. \\
...
\item User stories with acceptance criteria, and story points for relative complexity, not exact duration.
...
\begin{frame}{Frameworks, their natural use, and their roles}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{Structured rhythm}
\begin{itemize}
\item Scrum: bounded sprint goals, structured events and roles
\item Good for student teams needing cadence and review moments
\end{itemize}
\column{0.48\textwidth}
\textbf{Flow orientation}
\begin{itemize}
\item Kanban: continuous incoming work, flow-oriented management
\item Good for ops-heavy teams or highly varied work types
\end{itemize}
\end{columns}
\vspace{0.5em}
\begin{block}{Bridge}
DevOps shares responsibility across build, release, and operations; MLOps extends DevOps with data, models, drift, and governance concerns.
\end{block}
\coursefooter
\end{frame}
...
{Class 28 reconnects these practices to MLOps, where experimentation, delivery, ownership, and monitoring become one operational system.}

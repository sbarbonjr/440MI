...
\title{Class 1: Introduction to Course --- MLOps, Agile, Data Mining}
\author{\coursename}
\date{}
...
\item The three macro-blocks of the 36-session course: Python, Data-Driven, MLOps.
...
\item Agile AI and data mining: how to structure work when data, labels, and requirements all move.
...
\begin{frame}{Course arc: three macro-blocks, 36 sessions}
\begin{enumerate}
\item \textbf{Python block (Classes 1--12):} programming instrumentation --- language basics, data structures, functions, classes, files, pandas mechanics, first contact with scikit-learn, and EDA practice.
\item \textbf{Data-Driven block (Classes 13--20):} data theory --- deeper EDA, PCA and dimensionality reduction, feature engineering, modeling, evaluation, and serving interfaces.
\item \textbf{MLOps block (Classes 21--36):} software engineering, requirements, process models, agile methods, experiment tracking, delivery pipelines, and monitoring in production.
\end{enumerate}
\vspace{0.5em}
...
{Class 2 opens the Python block itself: what Python is, why it is the working language of this course, and a first tour of the toolchain (Jupyter, pandas, scikit-learn, Flask, Streamlit) we will use for the next eleven sessions.}
{The semester starts with systems thinking so that the programming instrumentation taught next always stays connected to a real deployment story.}
